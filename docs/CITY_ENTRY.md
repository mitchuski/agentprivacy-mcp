...
The compact Star orb is the human entry; this tool path is the agent entry. Neither changes permission merely because the key changed shape. Read [the City runtime](https://mages.city/city-mage.md) and [arrival contract](https://mages.city/city-key-arrival.md).
